...
public class FindProductByIdServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (type == null) {
				request.getRequestDispatcher("/Commoditymanagement/xiangqing.jsp").forward(request,response);
				return;
			}						
			request.getRequestDispatcher("/Commoditymanagement/editproduct.jsp").forward(request, response);
			return;
