...
<body>
	<%
		...
		String sqlstr = "SELECT * FROM userss";
	...
	<div id="content">
		...
		<table width="1000"   border="1" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td><a href="deleteUser1.jsp?id=<%=id%>">删除</a> 
				
				<a href="Modifyinfomation1.jsp?id=<%=id %>&na=<%=na %>&pass=<%=pass %>gen=<%=gen %>&email=<%=email %>&tel=<%=tel %>">修改</a></td>
			</tr>
			<%
				}
			%>
