...
<body>
<form method="post" action="${pageContext.request.contextPath}/findOrderByManyCondition" id="listform">
        ...
        <tr>
          ...
          <td>
          	<div class="button-group">
           		...
           		<a class="button border-main" href="${pageContext.request.contextPath}/findOrderById?id=${order.id}&type=admin"><span class="icon-edit"></span>查看</a>
           		<!--  已支付，弹出提示框由操作人确认 --> 
           		<c:if test="${order.paystate!=0 }">
          			<a class="button border-red" href="${pageContext.request.contextPath}/delOrderById?id=${order.id}&type=admin" onclick="return del(1,1,1)"><span class="icon-trash-o"></span> 删除</a> 
          		</c:if> 
          		<!--  未支付 ，不能删除-->
				<c:if test="${order.paystate==0 }">
