...
<body>
	...
	<div class="panel admin-panel margin-top">
		<div class="panel-head" id="add">
			<strong><span class="icon-pencil-square-o"></span>添加留言</strong>
		</div>
		<div class="body-content">
			<form method="post" class="form-x" action="${pageContext.request.contextPath}/AddMessage" enctype="multipart/form-data">
				<input type="hidden" id="telephone" name="userid" value="${user.id}" />
				<input type="hidden" class="input w50" name="name" value="${user.username}" />
