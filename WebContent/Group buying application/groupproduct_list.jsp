...
<head>
	...
	<%--导入css --%>
	<link rel="stylesheet" href="${pageContext.request.contextPath }/Commoditymanagement/css/homepage/body.css" type="text/css"  />
	<link rel="stylesheet" href="${pageContext.request.contextPath }/Commoditymanagement/css/main.css" type="text/css" />
</head>
<body class="main">
										...
										<c:forEach items="${bean.ps}" var="p" varStatus="vs">
											<td>
												<div class="divbookpic">
													<p>
														<a href="${pageContext.request.contextPath}/findgroupProductById?id=${p.id}">
															<img src="${pageContext.request.contextPath}${p.imgurl}" width="115" height="129" border="0" /> 
														</a>
													</p>
												</div>
												<div class="divlisttitle">
													<a href="${pageContext.request.contextPath}/findProductById?id=${p.id}">商品名称： ${p.name}<br />售价：￥${p.price} </a>
												</div>
											</td>
										</c:forEach>
									</tr>
