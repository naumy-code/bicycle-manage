	...
	<div class="xiangqing">
		<div class="neirong w">
			...
			<nav class="fr">
				...
				<li><a href="">F码通道</a></li>
				<li>|</li>
				<li><a href="${pageContext.request.contextPath}/findMessage">用户评价</a></li>
				<li>|</li>
				<li><a href="${pageContext.request.contextPath }/MessageBoard/addmessage.jsp">我要留言</a></li>
				<div class="clear"></div>
			</nav>
			<div class="clear"></div>
		</div>	
	...
	<div class="jieshao mt20 w">
		...
		<div class="right fr">
			...
			<div class="xiadan ml20 mt20">
					<a href="${pageContext.request.contextPath}/Group buying application/addorder.jsp?price=${p.price}"> <input class="jrgwc" type="button" name="jrgwc" value="加入团购" /></a>
