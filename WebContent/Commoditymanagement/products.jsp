...
<body>
<form method="post" action="${pageContext.request.contextPath}/findProductByManyCondition" id="listform">
  <div class="panel admin-panel">
	...
	<c:forEach items="${ps}" var="p">
        <tr>
          ...
          <td>${p.category}</td>
          <td><div class="button-group"> <a class="button border-main" href="${pageContext.request.contextPath}/findProductById?id=${p.id}&type=admin"><span class="icon-edit"></span> 修改</a> 
          <a class="button border-red" href="${pageContext.request.contextPath}/deleteProduct?id=${p.id}" onclick="return del(1,1,1)"><span class="icon-trash-o"></span> 删除</a> </div></td>
        </tr>
   	</c:forEach>
