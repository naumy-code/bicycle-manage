...
<head>
<title>电子书城</title>
<link rel="stylesheet" href="${pageContext.request.contextPath}/ShoppingCart/css/main.css" type="text/css" />
<script>
    //当商品数量发生变化时触发该方法
										...
										<td>
											...
											<div style="text-align:right; margin-top:10px">
												...
												<a href="${pageContext.request.contextPath}/showProductByPage">
													<img src="img/gwc_jx.gif" border="0" />
												</a>
												&nbsp;&nbsp;&nbsp;&nbsp;
                                                 <!--结账 -->
												<a href="${pageContext.request.contextPath}/ShoppingCart/order.jsp">
													<img src="${pageContext.request.contextPath}/ShoppingCart/img/gwc_buy.gif" border="0" />
												</a>
											</div>
										</td>
									</tr>
