...
<body>
		...
		<div class="jiesuandan mt20 center">
			...
			<div class="jiesuan fr">
				<div class="jiesuanjiage fl">
					合计（不含运费）：<span>${totalPrice}元</span>
	...
	<p>
		<span style="margin-left:250px;margin-top:100px;">收货地址：</span>
		<input id="receiverAddress" name="receiverAddress" type="text" value="" style="width: 350px;height:30px;" onkeyup="checkReceiverAddress();" /> 
		&nbsp;&nbsp;&nbsp;&nbsp;
		<span id="receiverAddressMsg"></span> <br />
		<span style="margin-left:250px;margin-top:100px;">收货人：</span>
		&nbsp;&nbsp;&nbsp;
		<input id="receiverName" name="receiverName" type="text" value="${user.username}" style="width: 150px;height:30px;" onkeyup="checkReceiverName();" /> 
		<span id="receiverNameMsg"></span> &nbsp;&nbsp;&nbsp;&nbsp; <br /> 
		<span style="margin-left:250px;margin-top:100px;">联系方式：</span>
		<input type="text" id="receiverPhone" name="receiverPhone" value="${user.telephone}" style="width: 150px;height:30px;" onkeyup="checkReceiverPhone();" /> <span id="receiverPhoneMsg"></span>
		&nbsp;&nbsp;&nbsp;&nbsp;
	</p>
	</form>
	<hr />
